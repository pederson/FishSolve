...
int main(int argc, char * argv[]){
	...
	*/
	...
	// cout << "cg resid: " << (rho - Op*x).norm() << endl;
	// x.fill(0);
	// niters = conjugate_gradient(&amgpc, Op, rho, x, nitmax);
	// cout << "iterated: " << niters << " times" << endl;
	...
	// x.fill(0);
	// niters = gmres_k(Op, rho, x, 20, nitmax);
	// cout << "iterated: " << niters << " times" << endl;
	// cout << "gmres resid: " << (rho - Op*x).norm() << endl;
	// x.fill(0);
	// niters = gmres_k(&ilupc, Op, rho, x, 20, nitmax);
	// cout << "iterated: " << niters << " times" << endl;
	...
	// cout << "gmres resid: " << (rho - Op*x).norm() << endl;
	// x.fill(0);
	// niters = gmres_k(&amgpc, Op, rho, x, 20, nitmax);
	// cout << "iterated: " << niters << " times" << endl;
	// cout << "pc gmres resid: " << norm_2(rho - Op*x) << endl;
